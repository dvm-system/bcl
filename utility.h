...
namespace Utility
{
	...
	*/
    ...
    {
    public:
        friend static inline const Null & Undef( );
    ...
    static inline const Null & Undef( ) { static const Null undef; return undef;}
...
#define SCALAR_TYPE( type_) template< > struct IsScalar< type_ > : public True { };
	...
	*/	
    namespace Detail
    {
	    ...
	    */
        ...
        {
            typedef IAccessorImp< Object_ > Base; //!< Базовый класс.
            typedef IAccessor< Object_ > This; //!< Текущий класс.

        public:
            typedef typename Base::Object * Pointer; //!< Указатель на объект.
            typedef const typename Base::Object * PointerC; //!< Указатель на объект.

        public:
            //! Создание нового объекта.
            static This New( ) { return static_cast< const This & >( Base::New( )); }

            //! Удаление объекта.
            static void Delete( This & object)  { Base::Delete( object); }

        public:
            //! Выполняет разыменование объекта.
            Pointer operator->( ) { return &( **static_cast< Base *>( this)); }

            //! Выполняет разыменование объекта.
            PointerC operator->( ) const { return &( **static_cast< const Base * >( this)); } 
        };
    }
	...
	*/
	...
	{	
        typedef Detail::IAccessor< Object_ > Base; //!< Интерфейс доступа.	

    public:
        typedef typename Base::Declaration Declaration; //!< Описание объекта.        
    ...
    public:
        //! Создание нового объекта.
        static This New( ) { return Base::New( ); }
    ...
    public:
        ...
        IObject( const This &object) : Base( object) { } 		

        //! Конструктор копирования.
        IObject( const Opposite &object) : Base( object) { *object; } 		
    ...
    private:
        //! Конструктор копирования.
        IObject( const Base &object) : Base( object) { }   
	};        
    ...
    public:
        typedef typename Base::Declaration Declaration; //!< Описание объекта.
        typedef typename Base::Reference Reference; //!< Ссылка на объект.
        typedef typename Base::ReferenceC ReferenceC; //!< Ссылка на объект.
        typedef typename Base::Pointer Pointer; //!< Указатель на объект.
        typedef typename Base::PointerC PointerC; //!< Указатель на объект.
    ...
    public:
        //! Создание нового объекта.
        static This New( ) { return This( Base::New( )); }

        //! Удаление объекта.
        static void Delete( This & object)  { Base::Delete( object); object.Reset( ); }
    ...
    public:
        ...
        IObject( const This &object) :
            IObject( static_cast< Base & >( object)) { }
    ...
    private:
        //! Конструктор копирования.
        IObject( const Base &object) :
             Base( object), m_ptr( this) { }
    private:
        Base *m_ptr; //!< Указатель на объект.
	};
	...
	template< class Object_ > class IObject< Object_ *, Utility::True >
        : public Detail::IAccessor< Object_ * >
	{ 
		typedef Detail::IAccessor< Object_ * > Base; //!< Базовый класс.
    ...
    public:
        ...
        //! Конструктор копирования.
        IObject( const Opposite &object) : Base( object) { }      
		...
		//! Признак определенного значения объекта.
        operator bool ( ) const { return Base::m_object != NULL; }	

        //! Устанавливает неопределенное значение.
		void Reset( ) { Base::m_object = NULL; }			
