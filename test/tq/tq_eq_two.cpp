//===- tq_eq_two.cpp - Transparent Queue Correctness Test ---------*- C -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements comparison test for equal queues with two elements.
//
//===----------------------------------------------------------------------===//
...
int main() {
  ...
  Q2.push(&I1);
  Q2.push(&I2);
  std::cout << "Equal queues with two elements: ";
